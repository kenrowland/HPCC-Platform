...
void MatchEnvironmentEvent::processEvent(const std::string &eventType, std::shared_ptr<EnvironmentNode> pEventNode)
{
...
void AttributeDependencyCreateEvent::doHandleEvent(std::shared_ptr<EnvironmentNode> pEventNode)
{
...
void InsertEnvironmentDataCreateEvent::doHandleEvent(std::shared_ptr<EnvironmentNode> pEventNode)
{
    pEventNode->addEnvironmentInsertData(m_envData);
}


void AttributeSetValueCreateEvent::addAttributeValue(const std::string &attrName, const std::string &attrVal)
{
    m_attrVals.push_back({attrName, attrVal});
}


void AttributeSetValueCreateEvent::doHandleEvent(std::shared_ptr<EnvironmentNode> pEventNode)
{
