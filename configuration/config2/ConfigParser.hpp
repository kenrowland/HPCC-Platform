...
class ConfigParser 
{
    public:
        ...
        ConfigParser(const std::string &basePath) : m_basePath(basePath) { };
        virtual ~ConfigParser() { };
        virtual bool parseEnvironmentConfig(const std::string &envFilename, const std::string &buildsetFilename, std::shared_ptr<ConfigItem> pConfig);
