...
class MatchEnvironmentEvent : public EnvironmentEvent
{
    public:

        MatchEnvironmentEvent() : EnvironmentEvent("create") {}
        virtual ~MatchEnvironmentEvent() {}
        void setItemType(const std::string &type) { m_itemType = type; }
        void setEventNodeAttributeName(const std::string &name) { m_eventNodeAttribute = m_targetAttribute = name; }
...
class AttributeDependencyCreateEvent : public MatchEnvironmentEvent
{
    public:
...
class InsertEnvironmentDataCreateEvent : public MatchEnvironmentEvent
{
    public:
...
class AttributeSetValueCreateEvent : public MatchEnvironmentEvent
{
    public:

        AttributeSetValueCreateEvent() {}
        virtual ~AttributeSetValueCreateEvent() {}
